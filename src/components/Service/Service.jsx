...
const Service = () => {
  return (
    <section className="container h-12 md:h-32">
      <div className="mx-auto my-4 grid w-full font-semibold rounded-md -translate-y-10 grid-cols-4 divide-x divide-black bg-white/40 p-2 shadow-lg  dark:text-black md:max-w-[800px] md:-translate-y-16 md:p-3">
